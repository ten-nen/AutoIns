...
Func _ClipBoard_FormatStr($iFormat)
	Local $aFormat[18] = [17, "文本", "位图", "图元文件图片", "SYLK 数据文件", "DIF 数据交换格式", "TIFF 标签图像文件格式", "OEM 文本", "DIB 设备无关位图", "调色板格式", _
			"画笔数据", "RIFF 资源交换文件格式", "WAVE 微软录音文件", "Unicode 文本", "增强型图元文件", "HDROP", "Locale", "DIB V5"]
